...
async def receive_webhook_ml(
    ...
    # Payment processing disabled — daily sync at 00:01 BRT handles all payments
    if topic == "payment" and data_id:
        logger.info(f"Payment webhook received but processing disabled (daily sync handles it)")
