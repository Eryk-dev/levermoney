#!/usr/bin/env python3
"""Bootstrap easy-utilidades January 2026 data for reconciliation test.

Steps:
  1. sync_seller_payments('easy-utilidades', '2026-01-01', '2026-01-31')
  2. sync_release_report('easy-utilidades', '2026-01-01', '2026-01-31')
  3. ingest_extrato_from_csv('easy-utilidades', <CSV>, '2026-01')
"""
...
SELLER = "easy-utilidades"
BEGIN = "2026-01-01"
END = "2026-01-31"
MONTH = "2026-01"
CSV_PATH = PROJECT_ROOT / "testes" / "data" / "extratos" / "extrato janeiro Easyutilidades.csv"
