#!/usr/bin/env python3
"""Bootstrap net-air February 2026 data for reconciliation test.

Steps:
  1. sync_seller_payments('net-air', '2026-02-01', '2026-02-28')
  2. sync_release_report('net-air', '2026-02-01', '2026-02-28')
  3. ingest_extrato_from_csv('net-air', <CSV>, '2026-02')
"""
