#!/usr/bin/env python3
"""Bootstrap netparts-sp February 2026 data for reconciliation test.

Steps:
  1. sync_seller_payments('netparts-sp', '2026-02-01', '2026-02-28')
  2. sync_release_report('netparts-sp', '2026-02-01', '2026-02-28')
  3. ingest_extrato_from_csv('netparts-sp', <CSV>, '2026-02')
"""
...
END = "2026-02-28"
MONTH = "2026-02"
CSV_PATH = PROJECT_ROOT / "testes" / "data" / "extratos" / "extrato fevereiro netparts.csv"
