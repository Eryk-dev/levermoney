"""E2e gate: 141air fev/2026 deve bater thresholds do contract.yml.

Espelha `test_reconciliation_141air_jan.py`. Mesmas 5 asserções; troca
apenas o `PERIOD`. Virou green após ERR-0014..0018 serem resolvidos
(2026-04-16).

Uso:
    pytest testes/e2e/test_reconciliation_141air_fev.py -m reconciliation -v
"""
