"""T-002 red test: 141air jan/2026 deve bater thresholds do contract.yml.

**Status esperado:** FAIL no baseline (56% créd / 86% déb vs. target 99,5%).
Cada fix (T-010..T-013) deve reduzir o gap. Quando ficar green,
virar gate bloqueante de CI.

Uso:
    pytest testes/e2e/test_reconciliation_141air_jan.py -m reconciliation -v
"""
