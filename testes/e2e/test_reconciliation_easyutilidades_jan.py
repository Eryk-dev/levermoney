"""E2E gate: easy-utilidades jan/2026 reconciliation must hit contract thresholds.

Run: pytest testes/e2e/test_reconciliation_easyutilidades_jan.py -m reconciliation -v
"""
