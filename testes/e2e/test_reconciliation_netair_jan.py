"""E2E gate: net-air jan/2026 reconciliation must hit contract thresholds.

20+ ERR-NNNN bugs resolved: ERR-0021 (check_payments multi dup), ERR-0022
(pos_payment skip), ERR-0023 (qr_pix sign), ERR-0024 (complementary types),
ERR-0025 (pagamento_conta / reembolso sign-driven), ERR-0026 (transferência
enviada as pix_out).

Run: pytest testes/e2e/test_reconciliation_netair_jan.py -m reconciliation -v
"""
