...
CACHE_PATH = Path(__file__).parent.parent / "data" / "cache_fev2026" / "141air_payments.json"
EXTRATO_PATH = Path(__file__).parent.parent / "data" / "extratos" / "extrato fevereiro 141Air.csv"
